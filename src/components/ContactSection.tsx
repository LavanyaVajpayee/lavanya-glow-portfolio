...
const contactInfo = [
  ...
  },
  {
    ...
    label: "LinkedIn",
    value: "lavanyavajpayee",
    href: "https://www.linkedin.com/in/lavanya-vajpayee-0554a428b",
  },
];
          ...
          <div className="text-center">
            <div className="card-elegant rounded-2xl p-8 mb-8">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                Currently pursuing B.Tech at VIT Chennai and actively seeking
                opportunities in software engineering, backend development, and
